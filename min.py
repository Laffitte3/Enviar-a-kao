...
fondo= pygame.image.load("imagenes/fondo.jfif")
...
pregunta= pygame.image.load("imagenes/salirloke.png")
pregunta= pygame.transform.scale(pregunta,(400,200))
pregunta_rect= pregunta.get_rect()

cursor= pygame.image.load("imagenes/cursor.png")
...
while running:
    ...
    if cursor_rect.colliderect(si_rect) and left :
        ...
        while pausa:
            ...
            fondo_2= pygame.image.load("imagenes/lokear.jpg")
